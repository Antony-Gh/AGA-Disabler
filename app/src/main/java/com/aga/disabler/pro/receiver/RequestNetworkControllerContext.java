...
public class RequestNetworkControllerContext {
...
private static RequestNetworkControllerContext mInstance;

public static synchronized RequestNetworkControllerContext getInstance() {
if(mInstance == null) {
mInstance = new RequestNetworkControllerContext();
}
return mInstance;
}
...
public void execute(final RequestNetworkContext requestNetwork, String method, String url, final String tag, final RequestNetworkContext.RequestListener requestListener) {
